      ...
      <div className="mb-6 w-full pr-2 md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="ml-2 text-black">Outgoings</p>
          </div>
          <div className="flex flex-col justify-start">
            <p className="my-4 text-left text-4xl font-bold text-gray-700">
              10,000
      ...
      <div className="w-full md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="text-black md:ml-4">Bonus</p>
          </div>
          <div className="flex flex-col justify-start">
            <p className="my-4 text-left text-4xl font-bold text-gray-700">
              3500
      ...
      <div className="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:mr-2 md:w-3/12">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-xs text-gray-600">Enoch Ndika</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="relative">
              <a href="#" className="relative block">
            ...
            <span className="mt-2 text-xs text-gray-600">Lionel Messi</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="relative">
              <a href="#" className="relative block">
            ...
            <span className="mt-2 text-xs text-gray-600">Jonathan Ilunga</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="relative">
              <a href="#" className="relative block">
            ...
            <span className="mt-2 text-xs text-gray-600">Maurice Lokumba</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="relative">
              <a href="#" className="relative block">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-xs text-gray-600">Dave Glad</span>
          </div>
        </div>
      </div>
