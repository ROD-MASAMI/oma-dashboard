      ...
      <div className="mb-6 w-full pr-2 md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="text-md ml-2 text-black">Doctors</p>
          </div>
      ...
      <div className="mb-6 w-full pr-2 md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="ml-2 text-black">Hospitals</p>
          </div>
      ...
      <div className="w-full md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="text-black md:ml-4">Patients</p>
          </div>
          <div className="flex flex-col justify-start">
            <p className="my-4 text-left text-4xl font-bold text-gray-700">2</p>
          </div>
        </div>
      </div>
    </div>
